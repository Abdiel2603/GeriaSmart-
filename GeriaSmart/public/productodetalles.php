...
if(isset($_GET['id_prod'])) {
    ...
    $sql  = "SELECT id_prod, nom_prod, `desc`, modelo, prec, stock, img, estatus FROM catalogo WHERE id_prod = ?";
...
<section class="centrado">
    <div class="container centrado-flex">
        <div class="opinion reveal">
            ...
            <div class="text-col reveal" style="justify-items: left">
                <h2>Descripción</h2>
                <p style="text-align: left"><?= htmlspecialchars($producto['desc']) ?></p>
                <div style="display: flex; gap: 10px;">
                    <p style="font-weight: bold">$<?= htmlspecialchars($producto['prec']) ?>    MXN, <?= htmlspecialchars($producto['stock']) ?> unidades disponibles</p>
                </div>
